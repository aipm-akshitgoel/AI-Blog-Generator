...
2. **Structure**: H2 and H3 markdown headers, short paragraphs, bullets where useful. Use GFM markdown tables when comparing options, fees, or criteria (header + |---| separator + rows; 3–5 columns max; no blank lines inside the table).
