            ...
            <div className="parul-container px-6">
                <div className="flex flex-col md:flex-row gap-12 md:gap-20 items-center justify-between">
                    ...
                    >
                        ...
                        <p className="text-lg md:text-xl text-gray-500 mb-8 md:mb-12 max-w-xl font-light italic leading-relaxed">
                        ...
                        <div className="flex flex-col gap-4 md:gap-6 mt-8 md:mt-12">
                            {["Boot-camp Short Courses", "Cohort Programs", "Online MBA & BBA"].map((prog, idx) => (
                                <div key={idx} className={`text-lg md:text-xl font-bold cursor-pointer transition-all ${idx === 0 ? 'text-[#342b7c] text-2xl md:text-3xl' : 'text-gray-400 hover:text-black'}`}>
                                    {prog}
                                </div>
                            ))}
                        </div>
                    ...
                    <motion.div
                        ...
                        whileInView={{ opacity: 1, x: 0 }}
                        transition={{ duration: 0.8 }}
                        className="bg-gray-50 border border-gray-100 p-6 md:p-12 rounded-[2rem] max-w-2xl relative"
                    >
                        <div className="mb-6 md:mb-10 block bg-[#342b7c] text-white w-fit px-4 py-1 rounded text-[10px] md:text-xs font-bold uppercase tracking-widest">Featured</div>
                        <h3 className="text-3xl md:text-5xl font-bold mb-4 md:mb-6">The GenAI Launchpad</h3>
                        <p className="text-lg md:text-xl text-gray-500 mb-8 md:mb-10 leading-relaxed font-light italic">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8 mb-8 md:mb-10">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <div className="text-[10px] uppercase text-gray-400 font-bold">Duration</div>
                                    <div className="text-base md:text-lg font-bold">3 months</div>
                                </div>
                            </div>
                            <div className="flex items-center gap-3">
                                <div className="p-3 bg-gray-200 rounded-full"><Calculator className="w-5 h-5 text-neutral-600" /></div>
                                <div>
                                    <div className="text-[10px] uppercase text-gray-400 font-bold">Format</div>
                                    <div className="text-base md:text-lg font-bold">Live Sessions</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-3 mb-10 md:mb-12">
                            ...
                            <div>
                                <div className="text-[10px] uppercase text-gray-400 font-bold">What You'll Gain:</div>
                                <div className="text-base md:text-lg font-bold italic">Launch-ready product skills with real-world application</div>
                            </div>
                        </div>

                        <a href="#" className="btn-primary w-full justify-center py-4 md:py-5 text-lg md:text-xl rounded-2xl group flex items-center gap-4 no-underline hover:text-black">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10">
                        {[
                            ...
                            <motion.div
                                ...
                                className="bg-gray-50 p-8 md:p-10 rounded-3xl hover:-translate-y-2 transition-all hover:shadow-xl"
                            >
                                <div className="w-16 h-16 bg-[#342b7c]/10 rounded-2xl mb-6 md:mb-8 flex items-center justify-center">
                                    <div className="w-8 h-8 rounded-full border-4 border-[#342b7c]" />
                                </div>
                                <h3 className="text-xl md:text-2xl font-bold mb-4">{item.title}</h3>
                                <p className="text-gray-500 italic font-light leading-relaxed text-sm md:text-base">{item.desc}</p>
                            </motion.div>
                        ))}
                    </div>
                </div>
