        ...
        <section className="bg-black py-20 overflow-hidden relative">
            <div className="parul-container px-6">
                <div className="flex flex-col md:flex-row gap-20 items-center justify-between">
                    ...
                    >
                        <h2 className="text-4xl md:text-7xl font-bold mb-6 md:mb-8 leading-tight text-white">
                            Curriculum Built <br />
                            for <span className="text-[#02a7b6]">Tomorrow</span>
                        </h2>

                        <p className="text-lg md:text-xl text-gray-400 mb-8 md:mb-12 font-light italic leading-relaxed">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 px-6 md:px-0">
                        {[
                            ...
                            <motion.div
                                ...
                                className="bg-white/5 backdrop-blur-xl border-l-4 border-[#02a7b6] p-6 md:p-8 rounded-r-2xl hover:bg-white/10 transition-colors"
                            >
                ...
                >
                    <a href="#" className="btn-primary flex items-center w-fit px-8 md:px-12 py-4 md:py-5 rounded-full text-lg md:text-xl font-black italic uppercase shadow-[0_0_50px_rgba(2,167,182,0.3)] group/btn no-underline">
                        Download Curriculum <ArrowRight className="w-5 h-5 md:w-6 md:h-6 group-hover/btn:translate-x-3 transition-transform ml-2" />
                    </a>
                </motion.div>
            </div>
        </section>
