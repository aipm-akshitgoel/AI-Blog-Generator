        ...
        <section className="bg-black py-20 overflow-hidden relative">
            <div className="parul-container px-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        <h2 className="text-4xl md:text-8xl font-black mb-8 leading-[0.9] md:leading-[0.8] tracking-tighter italic uppercase text-white">
                            Learn from <br />
                            <span className="text-[#02a7b6]">Visionaries</span>
                        </h2>

                        <p className="text-lg md:text-xl text-white/60 mb-12 max-w-lg font-light italic leading-relaxed">
                            Access 300+ CXO-led sessions featuring experts from Google, Meta, McKinsey, and more.
                        </p>

                        <div className="grid grid-cols-2 sm:grid-cols-3 gap-6 md:gap-8 mb-10 md:mb-12">
                            ...
                            <div className="flex flex-col items-start">
                                <div className="text-4xl md:text-5xl font-black italic mb-1 uppercase tracking-tighter text-white">300+</div>
                                <div className="text-[10px] font-black uppercase tracking-[0.3em] text-[#02a7b6]">Masters</div>
                            </div>
                            <div className="flex flex-col items-start">
                                <div className="text-4xl md:text-5xl font-black italic mb-1 uppercase tracking-tighter text-white">1000+</div>
                ...
                >
                    <a href="#" className="btn-primary flex items-center justify-center w-full px-8 py-5 rounded-full text-lg font-black italic uppercase shadow-[0_0_50px_rgba(2,167,182,0.3)] group/btn no-underline">
                        Meet Our Leaders <ArrowRight className="w-6 h-6 group-hover/btn:translate-x-3 transition-transform ml-2" />
                    </a>
                </motion.div>
            </div>
        </section>
